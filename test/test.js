...
describe('Read-only API', function(){
	...
	describe('interference with the original model', function() {
		...
		it('shouldn\'t delete instance methods' , function() {
			Fruit = Historical(sequelize.define('Fruit', { name: Sequelize.TEXT }), sequelize);
		...
		it('shouldn\'t interfere with hooks of the model' , function() {
			var triggered = 0;
			Fruit = Historical(sequelize.define('Fruit', { name: Sequelize.TEXT }, { hooks:{ beforeCreate: function(){ triggered++; }}}), sequelize);
			return sequelize.sync()
				.then(() => Fruit.create())
		...
		it('shouldn\'t interfere with setters' , function() {
			var triggered = 0;
			Fruit = Historical(sequelize.define('Fruit', {
				name: {
					type: Sequelize.TEXT,
